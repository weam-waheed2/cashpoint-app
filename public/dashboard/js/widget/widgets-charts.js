$(function () {
    ...
    var options = {
        ...
        colors: ["var(--bs-secondary-bg-subtle)", "var(--bs-secondary-bg-subtle)", "var(--bs-secondary)", "var(--bs-secondary-bg-subtle)", "var(--bs-secondary-bg-subtle)", "var(--bs-secondary-bg-subtle)", "var(--bs-secondary-bg-subtle)"],
        plotOptions: {
            bar: {
                borderRadius: 3,
                columnWidth: "48%",
    ...
    var options = {
        ...
        colors: ["var(--bs-secondary-bg-subtle)", "var(--bs-secondary-bg-subtle)", "var(--bs-secondary)", "var(--bs-secondary-bg-subtle)", "var(--bs-secondary-bg-subtle)"],
        plotOptions: {
            bar: {
                borderRadius: 3,
                columnWidth: "64%",
