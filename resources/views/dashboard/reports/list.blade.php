...
@section('content')
@include('dashboard.reports.modals.add')
                            ...
                            <tbody>
                                ...
                                @forelse($reports as $report)
                                    <tr>
                                        ...
                                        <td>
                                            {{$report->name == 'transfer_points' ? 'تحويل نقاط' : 'سحب رصيد'}}
                                        </td>
                                        <td>
                                            {{$report->UID}}
                                        </td>
                                        ...
                                        <td>
                                            <div class="action-btn">
                                                <a style="cursor: pointer" class="btn btn-primary btn-sm edit" data-bs-toggle="modal" data-bs-target="#editReportModal_{{$report->id}}">
                                    ...
                                    @include('dashboard.reports.modals.add', ['report' => $report])
                                @php($i++)
                                @empty
