...
<body class="sign_in_up_bg">
            ...
            <div>
                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                    <ul id="sidebarnav">
                        ...
                        @foreach (config($items) as $sidebar)
                            @if (isset($sidebar['children']) && !empty($sidebar['children']))
                                <li class="sidebar-item my-3">
                                    <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                                        <span class="d-flex">
                                            <i class="{{ $sidebar['icon'] }}"></i>
                                        </span>
                                        <span class="hide-menu">{{ $sidebar['name'] }}</span>
                                    </a>
                                    <ul aria-expanded="false" class="collapse first-level m-3">
                                        @foreach ($sidebar['children'] as $sub)
                                            <li class="sidebar-item">
                                                <a href="{{ url($sub['url']) }}" class="sidebar-link">
                                                    <div
                            ...
                            @else
                                <li class="sidebar-item my-3">
                                    <a class="sidebar-link" href="{{ url($sidebar['url']) }}" aria-expanded="false">
                                        <span>
                                            <i class="{{ $sidebar['icon'] }}"></i>
                                        </span>
                                        <span class="hide-menu"> {{ $sidebar['name'] }} </span>
                                        ...
                                        <a class="nav-link pe-0" href="javascript:void(0)" id="drop1"
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="user-profile-img">
                                                    <img src="{{ asset('dashboard/images/logos/user.png') }}"
                                                        ...
                                                        <div class="simplebar-offset" style="position:unset">
                                                            <div class="simplebar-content-wrapper" tabindex="0"
                                                                ...
                                                                <div class="simplebar-content" style="padding: 0px;">
                                                                    <div class="px-7 pt-3">
                                                                        <h5 class="mb-1 fs-3"> الاسم :  {{Auth::user()->name}}   </h5>
                                                                        <span class="mb-1 mt-2 d-block"> رقم الهاتف :  {{Auth::user()->phone}}  </span>
                                                                    </div>
                    ...
                    <nav class="navbar navbar-expand-xl container-fluid p-0">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item d-none d-xl-block">
                                <a href="{{ url('/home') }}" class="text-nowrap nav-link">
                                    <img src="{{ asset('dashboard/images/logos/logo.png') }}" width="180"
                                        alt="Logo-light">
                                </a>
                            </li>
                            <li class="nav-item d-none d-xl-block">
    ...
    <script src="{{ asset('dashboard/libs/fancybox/js/jquery.fancybox.min.js') }}"></script>
    ...
    <script src="{{ asset('dashboard/js/dashboards/dashboard3.js') }}"></script>
    <script>
